            ...
            TopAppBar(
                ...
                actions = {
                    InfoButton(
                        "Экспорт истории",
                        listOf(
                            "Весь чат или период (в т.ч. один день) в JSON или HTML.",
                            "«Что выгружать» — галочки по типам контента (фото, видео, музыка и т.д.).",
                            "Можно скачивать медиафайлы: HTML станет самодостаточным, JSON — с папкой files/.",
                            "Лимит размера медиа — крупные файлы не скачиваются, остаются метаданными.",
                            "Для каналов — выгрузка комментариев к постам вместе с их медиа.",
                        ),
                    )
                },
            )

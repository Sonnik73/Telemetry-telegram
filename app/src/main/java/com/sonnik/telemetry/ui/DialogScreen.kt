            ...
            TopAppBar(
                ...
                actions = {
                    InfoButton(
                        ...
                        listOf(
                            "Скрытый режим (зелёный глаз): история читается без отметки о прочтении — собеседник не видит, что вы прочитали.",
                            "Выключите режим — сообщения помечаются прочитанными и появляется поле для ответа.",
                            "Прокрутка вверх подгружает более старую историю.",
                            "Медиа видно прямо в переписке: тап открывает во внешнем просмотрщике, есть кнопка сохранения.",
                            "У сообщения есть кнопка «перевести».",
                        ),
                    )

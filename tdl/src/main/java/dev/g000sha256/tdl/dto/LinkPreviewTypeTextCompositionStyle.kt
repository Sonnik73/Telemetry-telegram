 ...
 */
public class LinkPreviewTypeTextCompositionStyle public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as LinkPreviewTypeTextCompositionStyle
    ...
    override fun toString(): String {
        return buildString {
            append("LinkPreviewTypeTextCompositionStyle")
            append("(")

 ...
 * @property optionId Identifier of the deleted option in the poll.
 * @property text Text of the option; 1-100 characters; may contain only custom emoji entities.
 */
public class MessagePollOptionDeleted public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as MessagePollOptionDeleted
    ...
    override fun toString(): String {
        return buildString {
            append("MessagePollOptionDeleted")
            append("(")

 ...
 * A rich message.
 *
 * @property message The rich message to send.
 * @property clearDraft Pass true to delete message draft in the chat.
 */
public class InputMessageRichMessage public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InputMessageRichMessage
    ...
    override fun toString(): String {
        return buildString {
            append("InputMessageRichMessage")
            append("(")
            append("message=")
            append(message)
            append(", ")
